...
#'
#' @return  similarities of each omics data

#' @return list of 5 elements describing the clusters obtained by CIMLR_noc, of which are the resulting clusters: 
